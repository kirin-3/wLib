  ...
  >
    ...
    >
      ...
      <div class="p-6 overflow-y-auto space-y-5 flex-1">
        <div>
          <label
            class="block text-sm font-medium mb-1.5 flex justify-between"
          ...
          <input
            v-model="title"
            type="text"
            placeholder="e.g. My Awesome RPG"
        ...
        <div>
          <label
            ...
            style="color: var(--text-secondary)"
            >F95Zone Thread URL</label
          >
          <input
            v-model="f95Url"
            type="text"
            placeholder="https://f95zone.to/threads/..."
            class="modal-input w-full !py-3 text-sm"
      ...
      <div
        class="px-6 py-5 flex justify-end gap-3"
