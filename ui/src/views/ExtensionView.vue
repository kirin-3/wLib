...
<template>
  <div class="p-8 max-w-4xl h-full flex flex-col overflow-y-auto">
    <header class="mb-8">
      <h2 class="text-3xl font-bold mb-2 tracking-tight" style="color: var(--text-primary)">Browser Extension</h2>
      <p class="text-sm pl-3" style="color: var(--text-secondary); border-left: 2px solid var(--brand)">Connect your browser to add games directly from F95Zone.</p>
    </header>
    ...
    <div class="space-y-8 pb-12">
      ...
      <section class="ext-card rounded-xl p-6">
        <h3 class="text-lg font-semibold mb-4 flex items-center gap-2" style="color: var(--text-primary)">
          <svg class="w-5 h-5" style="color: var(--brand)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12h5l2-9 4 18 2-9h5"/><circle cx="19" cy="12" r="2"/></svg>
          Connection Status
        </h3>
        ...
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs" style="color: var(--text-muted)">HTTP server on port 8183 · Last checked: {{ lastCheck || '—' }}</p>
            </div>
          </div>
      ...
      <section class="ext-card rounded-xl p-6">
        <h3 class="text-lg font-semibold mb-4 flex items-center gap-2" style="color: var(--text-primary)">
          <svg class="w-5 h-5" style="color: var(--brand)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
          Extension Files
        </h3>
      ...
      <section class="ext-card rounded-xl p-6">
        <h3 class="text-lg font-semibold mb-4 flex items-center gap-2" style="color: var(--text-primary)">
          <svg class="w-5 h-5" style="color: var(--brand)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>
          How to Install
        </h3>
      ...
      <section class="ext-card rounded-xl p-6">
        <h3 class="text-lg font-semibold mb-4 flex items-center gap-2" style="color: var(--text-primary)">
          <svg class="w-5 h-5" style="color: var(--brand)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/></svg>
          How It Works
        </h3>
        <div class="space-y-3 text-sm" style="color: var(--text-secondary)">
          ...
          <ul class="space-y-1.5 list-disc list-inside ml-2">
            ...
            <li>If the game is already in your library, shows <span class="font-medium" style="color: var(--brand)">"Open in wLib"</span> instead</li>
          </ul>
          <p class="text-xs mt-2" style="color: var(--text-muted)">Communication happens via a local HTTP server on <code class="ext-code" style="color: var(--brand)">localhost:8183</code>. wLib must be running for the extension to work.</p>
        </div>
      </section>
