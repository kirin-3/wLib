...
flowchart TD
    ...
    %% Flow
    UI <-->|Async Promises| API_JS
    API_JS <-->|pywebview bridge| API_PY
...
- **Frontend Framework**: Vue 3 (Composition API) + Vite + TailwindCSS
...
2. **JavaScript UI Context (Vue / Vite)**:
